...
#File Name: APIExplorerEndpointVisibilityv1.py
...
class apiEndpointVisibility(ClearPassAPILogin):
    ...
    def getAgentlessOnguardSettings(self,id="",disconnect_active_sessions="",ignore_disconnect_errors=""):
        '''
...
This parameter is ignored if disconnect_active_sessions is false.
        '''
        urlPath='/agentless-onguard/settings'
        dictPath={'id': id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        dictQuery={'disconnect_active_sessions': disconnect_active_sessions, 'ignore_disconnect_errors': ignore_disconnect_errors}
    ...
    def newAgentlessOnguardSettings(self,body=({})):
        '''
  ...
  "checksums_64": [
    ...
    def getAgentlessOnguardSettingsBySettings_id(self,settings_id=""):
        '''
        ...
        '''
        urlPath='/agentless-onguard/settings/{settings_id}'
        dictPath={'settings_id': settings_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateAgentlessOnguardSettingsBySettings_id(self,settings_id="",body=({})):
        '''
  ...
  "checksums_64": [
    ...
    def replaceAgentlessOnguardSettingsBySettings_id(self,settings_id="",body=({})):
        '''
  ...
  "checksums_64": [
    ...
    def deleteAgentlessOnguardSettingsBySettings_id(self,settings_id=""):
        '''
    ...
    def getAgentlessOnguardSettingsNameByName(self,name=""):
        '''
        ...
        '''
        urlPath='/agentless-onguard/settings/name/{name}'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateAgentlessOnguardSettingsNameByName(self,name="",body=({})):
        '''
  ...
  "checksums_64": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceAgentlessOnguardSettingsNameByName(self,name="",body=({})):
        '''
  ...
  "checksums_64": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteAgentlessOnguardSettingsNameByName(self,name=""):
        '''
    ...
    def getAgentlessOnguardSubnetMapping(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getAgentlessOnguardSubnetMappingBySubnet_mapping_id(self,subnet_mapping_id=""):
        '''
        Operation: Get a subnet mapping
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: subnet_mapping_id, Description: Numeric ID of subnet mapping
        '''
        urlPath='/agentless-onguard/subnet-mapping/{subnet_mapping_id}'
        dictPath={'subnet_mapping_id': subnet_mapping_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateAgentlessOnguardSubnetMappingBySubnet_mapping_id(self,subnet_mapping_id="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceAgentlessOnguardSubnetMappingBySubnet_mapping_id(self,subnet_mapping_id="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteAgentlessOnguardSubnetMappingBySubnet_mapping_id(self,subnet_mapping_id=""):
        '''
    ...
    def updateAgentlessOnguardSubnetMappingNameByName(self,name="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceAgentlessOnguardSubnetMappingNameByName(self,name="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteAgentlessOnguardSubnetMappingNameByName(self,name=""):
        '''
    ...
    def updateAgentlessOnguardSubnetMappingBySubnet_mapping_idEnable(self,subnet_mapping_id=""):
        '''
        Operation: Enable Agentless OnGuard Settings on client subnets
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: subnet_mapping_id, Description: Numeric ID of subnet mapping
        '''
        urlPath='/agentless-onguard/subnet-mapping/{subnet_mapping_id}/enable'
        dictPath={'subnet_mapping_id': subnet_mapping_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
    ...
    def updateAgentlessOnguardSubnetMappingBySubnet_mapping_idDisable(self,subnet_mapping_id=""):
        '''
        Operation: Disable Agentless OnGuard Settings on client subnets
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: subnet_mapping_id, Description: Numeric ID of subnet mapping
        '''
        urlPath='/agentless-onguard/subnet-mapping/{subnet_mapping_id}/disable'
        dictPath={'subnet_mapping_id': subnet_mapping_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch')
    ...
    def updateAgentlessOnguardSubnetMappingNameByNameEnable(self,name=""):
        '''
        Operation: Enable Agentless OnGuard Settings on client subnets by subnet mapping name
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: name, Description: Unique name of subnet mapping
        '''
        urlPath='/agentless-onguard/subnet-mapping/name/{name}/enable'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch')
    ...
    def updateAgentlessOnguardSubnetMappingNameByNameDisable(self,name=""):
        '''
        Operation: Disable Agentless OnGuard Settings on client subnets by subnet mapping name
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: name, Description: Unique name of subnet mapping
        '''
        urlPath='/agentless-onguard/subnet-mapping/name/{name}/disable'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch')
    ...
    def newDeviceProfilerDeviceFingerprint(self,body=({})):
        '''
  ...
  "ports": {
    "open": [
      ""
        ...
        '''
        urlPath='/device-profiler/device-fingerprint'
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getDeviceProfilerDeviceFingerprintByMac_or_ip(self,mac_or_ip=""):
        '''
        Operation: Get profiled device
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: mac_or_ip, Description: MAC or IP address of device
        '''
        urlPath='/device-profiler/device-fingerprint/{mac_or_ip}'
        dictPath={'mac_or_ip': mac_or_ip}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def deleteDeviceProfilerDeviceFingerprintByMac_or_ip(self,mac_or_ip=""):
        '''
    ...
    def getFingerprint(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
  ...
  "name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getFingerprintByFingerprint_id(self,fingerprint_id=""):
        '''
        Operation: Get a Fingerprint
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: fingerprint_id, Description: Numeric ID of the fingerprint
        '''
        urlPath='/fingerprint/{fingerprint_id}'
        dictPath={'fingerprint_id': fingerprint_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateFingerprintByFingerprint_id(self,fingerprint_id="",body=({})):
        '''
  ...
  "name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceFingerprintByFingerprint_id(self,fingerprint_id="",body=({})):
        '''
  ...
  "name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteFingerprintByFingerprint_id(self,fingerprint_id=""):
        '''
    ...
    def getFingerprintNameByCategoryFamilyName(self,category="",family="",name=""):
        '''
        ...
        '''
        urlPath='/fingerprint/name/{category}/{family}/{name}'
        dictPath={'category': category, 'family': family, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateFingerprintNameByCategoryFamilyName(self,category="",family="",name="",body=({})):
        '''
  ...
  "name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceFingerprintNameByCategoryFamilyName(self,category="",family="",name="",body=({})):
        '''
  ...
  "name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteFingerprintNameByCategoryFamilyName(self,category="",family="",name=""):
        '''
    ...
    def getConfigNetworkScan(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
        ...
        Optional Query Parameter Name: calculate_count, Description: Whether to calculate the total item count
        '''
        urlPath='/config/network-scan'
        dictQuery={'filter': filter, 'sort': sort, 'offset': offset, 'limit': limit, 'calculate_count': calculate_count}
        urlPath = _generateParameterisedURL(parameters=dictQuery,url=urlPath)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def newConfigNetworkScan(self,body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getConfigNetworkScanByScan_id(self,scan_id=""):
        '''
        Operation: Get a NetworkScan
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: scan_id, Description: Numeric ID of the NetworkScan
        '''
        urlPath='/config/network-scan/{scan_id}'
        dictPath={'scan_id': scan_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateConfigNetworkScanByScan_id(self,scan_id="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceConfigNetworkScanByScan_id(self,scan_id="",body=({})):
        '''
  ...
  "enabled": false
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteConfigNetworkScanByScan_id(self,scan_id=""):
        '''
    ...
    def updateConfigNetworkScanByScan_idEnable(self,scan_id=""):
        '''
        Operation: Update some fields of a NetworkScan
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: scan_id, Description: Numeric ID of the NetworkScan
        '''
        urlPath='/config/network-scan/{scan_id}/enable'
        dictPath={'scan_id': scan_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch')
    ...
    def updateConfigNetworkScanByScan_idDisable(self,scan_id=""):
        '''
        Operation: Update some fields of a NetworkScan
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: scan_id, Description: Numeric ID of the NetworkScan
        '''
        urlPath='/config/network-scan/{scan_id}/disable'
        dictPath={'scan_id': scan_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch')
    ...
    def getOnguardActivity(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
        ...
        Optional Query Parameter Name: calculate_count, Description: Whether to calculate the total item count
        '''
        urlPath='/onguard-activity'
        dictQuery={'filter': filter, 'sort': sort, 'offset': offset, 'limit': limit, 'calculate_count': calculate_count}
        urlPath = _generateParameterisedURL(parameters=dictQuery,url=urlPath)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def getOnguardActivityByOnguard_activity_id(self,onguard_activity_id=""):
        '''
        ...
        '''
        urlPath='/onguard-activity/{onguard_activity_id}'
        dictPath={'onguard_activity_id': onguard_activity_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def getOnguardActivityHost_macByHost_mac(self,host_mac=""):
        '''
        ...
        '''
        urlPath='/onguard-activity/host_mac/{host_mac}'
        dictPath={'host_mac': host_mac}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def newOnguardActivityMessage(self,body=({})):
        '''
  ...
  "is_broadcast": false
        ...
        '''
        urlPath='/onguard-activity/message'
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def newOnguardActivityNotification(self,body=({})):
        '''
  ...
  "endpoint_status": ""
        ...
        '''
        urlPath='/onguard-activity/notification'
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    ...
    def getOnguardCustomScript(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
        ...
        Optional Query Parameter Name: calculate_count, Description: Whether to calculate the total item count
        '''
        urlPath='/onguard-custom-script'
        dictQuery={'filter': filter, 'sort': sort, 'offset': offset, 'limit': limit, 'calculate_count': calculate_count}
        urlPath = _generateParameterisedURL(parameters=dictQuery,url=urlPath)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def newOnguardCustomScript(self,body=({})):
        '''
  ...
  "rules": "object"
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getOnguardCustomScriptByOnguard_custom_script_id(self,onguard_custom_script_id=""):
        '''
        ...
        '''
        urlPath='/onguard-custom-script/{onguard_custom_script_id}'
        dictPath={'onguard_custom_script_id': onguard_custom_script_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateOnguardCustomScriptByOnguard_custom_script_id(self,onguard_custom_script_id="",body=({})):
        '''
  ...
  "rules": "object"
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceOnguardCustomScriptByOnguard_custom_script_id(self,onguard_custom_script_id="",body=({})):
        '''
  ...
  "rules": "object"
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteOnguardCustomScriptByOnguard_custom_script_id(self,onguard_custom_script_id=""):
        '''
    ...
    def getOnguardCustomScriptNameByName(self,name=""):
        '''
        ...
        '''
        urlPath='/onguard-custom-script/name/{name}'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateOnguardCustomScriptNameByName(self,name="",body=({})):
        '''
  ...
  "rules": "object"
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceOnguardCustomScriptNameByName(self,name="",body=({})):
        '''
  ...
  "rules": "object"
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteOnguardCustomScriptNameByName(self,name=""):
        '''
    ...
    def getOnguardGlobalSettings(self,name=""):
        '''
        ...
        Required Path Parameter Name: name, Description: Unique name of OnGuard Custom Script
        '''
        urlPath='/onguard/global-settings'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newOnguardGlobalSettings(self,body=({})):
        '''
  ...
  "WirelessAllowedSubnets": ""
    ...
    def getOnguardSettings(self,body=({})):
        '''
  ...
  "custom_remediation": "object"
    ...
    def getOnguardPolicyManagerZones(self,body=({})):
        '''
  ...
  "custom_remediation": "object"
        ...
        '''
        urlPath='/onguard/policy-manager-zones'
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get',query=body)
    def newOnguardPolicyManagerZones(self,body=({})):
        '''
  ...
  "override_server_ips": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getOnguardPolicyManagerZonesByPolicy_manager_zones_id(self,policy_manager_zones_id=""):
        '''
        ...
        '''
        urlPath='/onguard/policy-manager-zones/{policy_manager_zones_id}'
        dictPath={'policy_manager_zones_id': policy_manager_zones_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateOnguardPolicyManagerZonesByPolicy_manager_zones_id(self,policy_manager_zones_id="",body=({})):
        '''
  ...
  "override_server_ips": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceOnguardPolicyManagerZonesByPolicy_manager_zones_id(self,policy_manager_zones_id="",body=({})):
        '''
  ...
  "override_server_ips": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteOnguardPolicyManagerZonesByPolicy_manager_zones_id(self,policy_manager_zones_id=""):
        '''
    ...
    def getOnguardPolicyManagerZonesNameByName(self,name=""):
        '''
        ...
        '''
        urlPath='/onguard/policy-manager-zones/name/{name}'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateOnguardPolicyManagerZonesNameByName(self,name="",body=({})):
        '''
  ...
  "override_server_ips": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceOnguardPolicyManagerZonesNameByName(self,name="",body=({})):
        '''
  ...
  "override_server_ips": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteOnguardPolicyManagerZonesNameByName(self,name=""):
        '''
    ...
    def getProfilerSubnetMapping(self,name=""):
        '''
        Operation: Get a list of profiler subnet mappings
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: name, Description: Unique name of the policy manager zone
        '''
        urlPath='/profiler-subnet-mapping'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newProfilerSubnetMapping(self,body=({})):
        '''
  ...
  "ext_accounts": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getProfilerSubnetMappingByScan_typeProfiler_subnet_mapping_id(self,scan_type="",profiler_subnet_mapping_id=""):
        '''
        ...
        '''
        urlPath='/profiler-subnet-mapping/{scan_type}/{profiler_subnet_mapping_id}'
        dictPath={'scan_type': scan_type, 'profiler_subnet_mapping_id': profiler_subnet_mapping_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateProfilerSubnetMappingByScan_typeProfiler_subnet_mapping_id(self,scan_type="",profiler_subnet_mapping_id="",body=({})):
        '''
  ...
  "ext_accounts": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceProfilerSubnetMappingByScan_typeProfiler_subnet_mapping_id(self,scan_type="",profiler_subnet_mapping_id="",body=({})):
        '''
  ...
  "ext_accounts": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteProfilerSubnetMappingByScan_typeProfiler_subnet_mapping_id(self,scan_type="",profiler_subnet_mapping_id=""):
        '''
    ...
    def getProfilerSubnetMappingByScan_typeNetworkNetwork(self,scan_type="",network=""):
        '''
        Operation: Get a profiler subnet mapping
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: scan_type, Description: Scan Type of Profiler Subnet Mapping
        ...
        '''
        urlPath='/profiler-subnet-mapping/{scan_type}/network/{network}'
        dictPath={'scan_type': scan_type, 'network': network}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateProfilerSubnetMappingByScan_typeNetworkNetwork(self,scan_type="",network="",body=({})):
        '''
        Operation: Update some fields of a profiler subnet mapping
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: scan_type, Description: Scan Type of Profiler Subnet Mapping
  ...
  "ext_accounts": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceProfilerSubnetMappingByScan_typeNetworkNetwork(self,scan_type="",network="",body=({})):
        '''
        Operation: Replace a profiler subnet mapping
        HTTP Status Response Codes: 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity, 200 OK, 204 No Content, 304 Not Modified, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 422 Unprocessable Entity
        Required Path Parameter Name: scan_type, Description: Scan Type of Profiler Subnet Mapping
  ...
  "ext_accounts": [
    ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteProfilerSubnetMappingByScan_typeNetworkNetwork(self,scan_type="",network=""):
        '''
        Operation: Delete a profiler subnet mapping
        HTTP Status Response Codes: 204 No Content, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 204 No Content, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: scan_type, Description: Scan Type of Profiler Subnet Mapping
    ...
    def getWindowsHotfix(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
        ...
        Optional Query Parameter Name: calculate_count, Description: Whether to calculate the total item count
        '''
        urlPath='/windows-hotfix'
        dictQuery={'filter': filter, 'sort': sort, 'offset': offset, 'limit': limit, 'calculate_count': calculate_count}
        urlPath = _generateParameterisedURL(parameters=dictQuery,url=urlPath)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def newWindowsHotfix(self,body=({})):
        '''
  ...
  "description": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getWindowsHotfixByWindows_hotfix_id(self,windows_hotfix_id=""):
        '''
        ...
        '''
        urlPath='/windows-hotfix/{windows_hotfix_id}'
        dictPath={'windows_hotfix_id': windows_hotfix_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateWindowsHotfixByWindows_hotfix_id(self,windows_hotfix_id="",body=({})):
        '''
  ...
  "description": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceWindowsHotfixByWindows_hotfix_id(self,windows_hotfix_id="",body=({})):
        '''
  ...
  "description": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteWindowsHotfixByWindows_hotfix_id(self,windows_hotfix_id=""):
        '''
    ...
    def getWindowsHotfixKbidByKbidOperating_systemOperating_system(self,kbid="",operating_system=""):
        '''
        ...
        '''
        urlPath='/windows-hotfix/kbid/{kbid}/operating_system/{operating_system}'
        dictPath={'kbid': kbid, 'operating_system': operating_system}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateWindowsHotfixKbidByKbidOperating_systemOperating_system(self,kbid="",operating_system="",body=({})):
        '''
  ...
  "description": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceWindowsHotfixKbidByKbidOperating_systemOperating_system(self,kbid="",operating_system="",body=({})):
        '''
  ...
  "description": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteWindowsHotfixKbidByKbidOperating_systemOperating_system(self,kbid="",operating_system=""):
        '''
