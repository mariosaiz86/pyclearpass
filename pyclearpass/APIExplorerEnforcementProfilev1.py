...
#File Name: APIExplorerEnforcementProfilev1.py
...
class apiEnforcementProfiles(ClearPassAPILogin):
    ...
    def getEnforcementProfileDurCaptivePortalProfileByProduct_name(self,product_name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/captive-portal-profile/{product_name}'
        dictPath={'product_name': product_name}
    ...
    def newEnforcementProfileDurCaptivePortalProfileByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "aos_attributes": {
    ...
    def getEnforcementProfileDurCaptivePortalProfileByProduct_nameCaptive_portal_profile_id(self,product_name="",captive_portal_profile_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/captive-portal-profile/{product_name}/{captive_portal_profile_id}'
        dictPath={'product_name': product_name, 'captive_portal_profile_id': captive_portal_profile_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurCaptivePortalProfileByProduct_nameCaptive_portal_profile_id(self,product_name="",captive_portal_profile_id="",body=({})):
        '''
  ...
  "aos_attributes": {
    ...
    def replaceEnforcementProfileDurCaptivePortalProfileByProduct_nameCaptive_portal_profile_id(self,product_name="",captive_portal_profile_id="",body=({})):
        '''
  ...
  "aos_attributes": {
    ...
    def deleteEnforcementProfileDurCaptivePortalProfileByProduct_nameCaptive_portal_profile_id(self,product_name="",captive_portal_profile_id=""):
        '''
    ...
    def getEnforcementProfileDurCaptivePortalProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/captive-portal-profile/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurCaptivePortalProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "aos_attributes": {
    ...
    "allowed_net_destinations": [
      ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurCaptivePortalProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "aos_attributes": {
    ...
    "allowed_net_destinations": [
      ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurCaptivePortalProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurDurClassByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Policies
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/dur-class/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurDurClassByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "aos_cx_rules": [
    {
      ...
      "icmp_code": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurDurClassByProduct_nameDur_class_id(self,product_name="",dur_class_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/dur-class/{product_name}/{dur_class_id}'
        dictPath={'product_name': product_name, 'dur_class_id': dur_class_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurDurClassByProduct_nameDur_class_id(self,product_name="",dur_class_id="",body=({})):
        '''
  ...
  "aos_cx_rules": [
    {
      ...
      "icmp_code": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurDurClassByProduct_nameDur_class_id(self,product_name="",dur_class_id="",body=({})):
        '''
  ...
  "aos_cx_rules": [
    {
      ...
      "icmp_code": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurDurClassByProduct_nameDur_class_id(self,product_name="",dur_class_id=""):
        '''
    ...
    def getEnforcementProfileDurDurClassByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/dur-class/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurDurClassByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "aos_cx_rules": [
    {
      ...
      "icmp_code": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurDurClassByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "aos_cx_rules": [
    {
      ...
      "icmp_code": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurDurClassByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfile(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
    ...
    def newEnforcementProfile(self,body=({})):
        '''
  ...
  "dur_config": {
    ...
    "aos_cx_config": {
      ...
      "policy_name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileByEnforcement_profile_id(self,enforcement_profile_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile/{enforcement_profile_id}'
        dictPath={'enforcement_profile_id': enforcement_profile_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileByEnforcement_profile_id(self,enforcement_profile_id="",body=({})):
        '''
  ...
  "dur_config": {
    ...
    "aos_cx_config": {
      ...
      "policy_name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileByEnforcement_profile_id(self,enforcement_profile_id="",body=({})):
        '''
  ...
  "dur_config": {
    ...
    "aos_cx_config": {
      ...
      "policy_name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileByEnforcement_profile_id(self,enforcement_profile_id=""):
        '''
    ...
    def getEnforcementProfileNameByName(self,name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile/name/{name}'
        dictPath={'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileNameByName(self,name="",body=({})):
        '''
  ...
  "dur_config": {
    ...
    "aos_cx_config": {
      ...
      "policy_name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileNameByName(self,name="",body=({})):
        '''
  ...
  "dur_config": {
    ...
    "aos_cx_config": {
      ...
      "policy_name": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileNameByName(self,name=""):
        '''
    ...
    def getEnforcementProfileDurEthertypeAccessControlListByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Ethertype Access Control Lists
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/ethertype-access-control-list/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurEthertypeAccessControlListByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurEthertypeAccessControlListByProduct_nameEthertype_access_control_list_id(self,product_name="",ethertype_access_control_list_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/ethertype-access-control-list/{product_name}/{ethertype_access_control_list_id}'
        dictPath={'product_name': product_name, 'ethertype_access_control_list_id': ethertype_access_control_list_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurEthertypeAccessControlListByProduct_nameEthertype_access_control_list_id(self,product_name="",ethertype_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurEthertypeAccessControlListByProduct_nameEthertype_access_control_list_id(self,product_name="",ethertype_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurEthertypeAccessControlListByProduct_nameEthertype_access_control_list_id(self,product_name="",ethertype_access_control_list_id=""):
        '''
    ...
    def getEnforcementProfileDurEthertypeAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/ethertype-access-control-list/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurEthertypeAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurEthertypeAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurEthertypeAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurMacAccessControlListByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of MAC Access Control Lists
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/mac-access-control-list/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurMacAccessControlListByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurMacAccessControlListByProduct_nameMac_access_control_list_id(self,product_name="",mac_access_control_list_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/mac-access-control-list/{product_name}/{mac_access_control_list_id}'
        dictPath={'product_name': product_name, 'mac_access_control_list_id': mac_access_control_list_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurMacAccessControlListByProduct_nameMac_access_control_list_id(self,product_name="",mac_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurMacAccessControlListByProduct_nameMac_access_control_list_id(self,product_name="",mac_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurMacAccessControlListByProduct_nameMac_access_control_list_id(self,product_name="",mac_access_control_list_id=""):
        '''
    ...
    def getEnforcementProfileDurMacAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/mac-access-control-list/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurMacAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurMacAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "subnet_bits": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurMacAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurNatPoolByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of NAT Pools
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/nat-pool/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurNatPoolByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "destination_nat_ip_address": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurNatPoolByProduct_nameNat_pool_id(self,product_name="",nat_pool_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/nat-pool/{product_name}/{nat_pool_id}'
        dictPath={'product_name': product_name, 'nat_pool_id': nat_pool_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurNatPoolByProduct_nameNat_pool_id(self,product_name="",nat_pool_id="",body=({})):
        '''
  ...
  "destination_nat_ip_address": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNatPoolByProduct_nameNat_pool_id(self,product_name="",nat_pool_id="",body=({})):
        '''
  ...
  "destination_nat_ip_address": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNatPoolByProduct_nameNat_pool_id(self,product_name="",nat_pool_id=""):
        '''
    ...
    def getEnforcementProfileDurNatPoolByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/nat-pool/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurNatPoolByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "destination_nat_ip_address": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNatPoolByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "destination_nat_ip_address": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNatPoolByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurNetDestinationByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Net Destinations
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/net-destination/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurNetDestinationByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "position": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurNetDestinationByProduct_nameNet_destination_id(self,product_name="",net_destination_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/net-destination/{product_name}/{net_destination_id}'
        dictPath={'product_name': product_name, 'net_destination_id': net_destination_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurNetDestinationByProduct_nameNet_destination_id(self,product_name="",net_destination_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "position": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNetDestinationByProduct_nameNet_destination_id(self,product_name="",net_destination_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "position": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNetDestinationByProduct_nameNet_destination_id(self,product_name="",net_destination_id=""):
        '''
    ...
    def getEnforcementProfileDurNetDestinationByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/net-destination/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurNetDestinationByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "position": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNetDestinationByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "position": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNetDestinationByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurNetServiceByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Net Services
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/net-service/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurNetServiceByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "application_level_gateway": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurNetServiceByProduct_nameNet_service_id(self,product_name="",net_service_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/net-service/{product_name}/{net_service_id}'
        dictPath={'product_name': product_name, 'net_service_id': net_service_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurNetServiceByProduct_nameNet_service_id(self,product_name="",net_service_id="",body=({})):
        '''
  ...
  "application_level_gateway": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNetServiceByProduct_nameNet_service_id(self,product_name="",net_service_id="",body=({})):
        '''
  ...
  "application_level_gateway": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNetServiceByProduct_nameNet_service_id(self,product_name="",net_service_id=""):
        '''
    ...
    def getEnforcementProfileDurNetServiceByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/net-service/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurNetServiceByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "application_level_gateway": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurNetServiceByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "application_level_gateway": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurNetServiceByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurPolicerProfileByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Policer Profiles
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/policer-profile/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurPolicerProfileByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "violate_qos_profile": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurPolicerProfileByProduct_namePolicer_profile_id(self,product_name="",policer_profile_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/policer-profile/{product_name}/{policer_profile_id}'
        dictPath={'product_name': product_name, 'policer_profile_id': policer_profile_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurPolicerProfileByProduct_namePolicer_profile_id(self,product_name="",policer_profile_id="",body=({})):
        '''
  ...
  "violate_qos_profile": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurPolicerProfileByProduct_namePolicer_profile_id(self,product_name="",policer_profile_id="",body=({})):
        '''
  ...
  "violate_qos_profile": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurPolicerProfileByProduct_namePolicer_profile_id(self,product_name="",policer_profile_id=""):
        '''
    ...
    def getEnforcementProfileDurPolicerProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/policer-profile/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurPolicerProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "violate_qos_profile": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurPolicerProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "violate_qos_profile": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurPolicerProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurPolicyByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Policies
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/policy/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurPolicyByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "priority_code_point": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurPolicyByProduct_namePolicy_id(self,product_name="",policy_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/policy/{product_name}/{policy_id}'
        dictPath={'product_name': product_name, 'policy_id': policy_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurPolicyByProduct_namePolicy_id(self,product_name="",policy_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "priority_code_point": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurPolicyByProduct_namePolicy_id(self,product_name="",policy_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "priority_code_point": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurPolicyByProduct_namePolicy_id(self,product_name="",policy_id=""):
        '''
    ...
    def getEnforcementProfileDurPolicyByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/policy/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurPolicyByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "priority_code_point": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurPolicyByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "priority_code_point": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurPolicyByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurQosProfileByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of QoS Profiles
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/qos-profile/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurQosProfileByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "dot1p": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurQosProfileByProduct_nameQos_profile_id(self,product_name="",qos_profile_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/qos-profile/{product_name}/{qos_profile_id}'
        dictPath={'product_name': product_name, 'qos_profile_id': qos_profile_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurQosProfileByProduct_nameQos_profile_id(self,product_name="",qos_profile_id="",body=({})):
        '''
  ...
  "dot1p": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurQosProfileByProduct_nameQos_profile_id(self,product_name="",qos_profile_id="",body=({})):
        '''
  ...
  "dot1p": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurQosProfileByProduct_nameQos_profile_id(self,product_name="",qos_profile_id=""):
        '''
    ...
    def getEnforcementProfileDurQosProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/qos-profile/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurQosProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "dot1p": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurQosProfileByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "dot1p": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurQosProfileByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurSessionAccessControlListByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Session Access Control Lists
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/session-access-control-list/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurSessionAccessControlListByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "tos": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurSessionAccessControlListByProduct_nameSession_access_control_list_id(self,product_name="",session_access_control_list_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/session-access-control-list/{product_name}/{session_access_control_list_id}'
        dictPath={'product_name': product_name, 'session_access_control_list_id': session_access_control_list_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurSessionAccessControlListByProduct_nameSession_access_control_list_id(self,product_name="",session_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "tos": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurSessionAccessControlListByProduct_nameSession_access_control_list_id(self,product_name="",session_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "tos": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurSessionAccessControlListByProduct_nameSession_access_control_list_id(self,product_name="",session_access_control_list_id=""):
        '''
    ...
    def getEnforcementProfileDurSessionAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/session-access-control-list/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurSessionAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "tos": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurSessionAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "tos": 0
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurSessionAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurStatelessAccessControlListByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Stateless Access Control Lists
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/stateless-access-control-list/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurStatelessAccessControlListByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "time_range": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurStatelessAccessControlListByProduct_nameStateless_access_control_list_id(self,product_name="",stateless_access_control_list_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/stateless-access-control-list/{product_name}/{stateless_access_control_list_id}'
        dictPath={'product_name': product_name, 'stateless_access_control_list_id': stateless_access_control_list_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurStatelessAccessControlListByProduct_nameStateless_access_control_list_id(self,product_name="",stateless_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "time_range": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurStatelessAccessControlListByProduct_nameStateless_access_control_list_id(self,product_name="",stateless_access_control_list_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "time_range": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurStatelessAccessControlListByProduct_nameStateless_access_control_list_id(self,product_name="",stateless_access_control_list_id=""):
        '''
    ...
    def getEnforcementProfileDurStatelessAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/stateless-access-control-list/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurStatelessAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "time_range": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurStatelessAccessControlListByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "time_range": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurStatelessAccessControlListByProduct_nameNameName(self,product_name="",name=""):
        '''
    ...
    def getEnforcementProfileDurTimeRangeByProduct_name(self,product_name=""):
        '''
        Operation: GET a list of Time Ranges
        HTTP Status Response Codes: 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type, 200 OK, 401 Unauthorized, 403 Forbidden, 404 Not Found, 406 Not Acceptable, 415 Unsupported Media Type
        Required Path Parameter Name: product_name, Description: Product Name
        '''
        urlPath='/enforcement-profile-dur/time-range/{product_name}'
        dictPath={'product_name': product_name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newEnforcementProfileDurTimeRangeByProduct_name(self,product_name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "end_time": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='post',query=body)
    def getEnforcementProfileDurTimeRangeByProduct_nameTime_range_id(self,product_name="",time_range_id=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/time-range/{product_name}/{time_range_id}'
        dictPath={'product_name': product_name, 'time_range_id': time_range_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def updateEnforcementProfileDurTimeRangeByProduct_nameTime_range_id(self,product_name="",time_range_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "end_time": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurTimeRangeByProduct_nameTime_range_id(self,product_name="",time_range_id="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "end_time": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurTimeRangeByProduct_nameTime_range_id(self,product_name="",time_range_id=""):
        '''
    ...
    def getEnforcementProfileDurTimeRangeByProduct_nameNameName(self,product_name="",name=""):
        '''
        ...
        '''
        urlPath='/enforcement-profile-dur/time-range/{product_name}/name/{name}'
        dictPath={'product_name': product_name, 'name': name}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def updateEnforcementProfileDurTimeRangeByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "end_time": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='patch',query=body)
    def replaceEnforcementProfileDurTimeRangeByProduct_nameNameName(self,product_name="",name="",body=({})):
        '''
  ...
  "rules": [
    {
      ...
      "end_time": ""
        ...
        body = _removeEmptyKeys(keys=body)
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='put',query=body)
    def deleteEnforcementProfileDurTimeRangeByProduct_nameNameName(self,product_name="",name=""):
        '''
