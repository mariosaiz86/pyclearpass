...
#File Name: APIExplorerCertificateAuthorityv1.py
...
class apiCertificateAuthority(ClearPassAPILogin):
    ...
    def getCertificate(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
    ...
    def getCertificateByCertificate_id(self,certificate_id=""):
        '''
        ...
        '''
        urlPath='/certificate/{certificate_id}'
        dictPath={'certificate_id': certificate_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
        
        
    def deleteCertificateByCertificate_id(self,certificate_id=""):
        '''
    ...
    def getCertificateByCert_idChain(self,cert_id=""):
        '''
        ...
        '''
        urlPath='/certificate/{cert_id}/chain'
        dictPath={'cert_id': cert_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        return ClearPassAPILogin._sendRequest(self,url=urlPath,method='get')
    ...
    def newCertificateByCert_idExport(self,cert_id="",body=({})):
        '''
  ...
  "export_password2": ""
        ...
        '''
        urlPath='/certificate/{cert_id}/export'
        dictPath={'cert_id': cert_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
    ...
    def newCertificateImport(self,body=({})):
        '''
  ...
  "key_passphrase": ""
    ...
    def newCertificateNew(self,body=({})):
        '''
...
Multiple values can be included, one per line,issue_cert (boolean, optional): Issue this certificate immediately,days (string, optional): The number of days before the certificate will expire,device_name (string, optional): Device name to store in certificate subject alternative name,custom_field (string, optional): Custom fields to store in certificate subject alternative name,user_email_address (string, optional): User’s email address to store in certificate subject alternative name}
  ...
  "user_email_address": ""
    ...
    def newCertificateByCert_idReject(self,cert_id="",body=({})):
        '''
  ...
  "confirm_reject": false
        ...
        '''
        urlPath='/certificate/{cert_id}/reject'
        dictPath={'cert_id': cert_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        body = _removeEmptyKeys(keys=body)
    ...
    def newCertificateRequest(self,body=({})):
        '''
  ...
  "days": ""
    ...
    def newCertificateByCert_idRevoke(self,cert_id="",body=({})):
        '''
  ...
  "confirm_revoke": false
        ...
        '''
        urlPath='/certificate/{cert_id}/revoke'
        dictPath={'cert_id': cert_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        body = _removeEmptyKeys(keys=body)
    ...
    def newCertificateByCert_idSign(self,cert_id="",body=({})):
        '''
  ...
  "custom_subject_alt_name": [
    {
      ...
      "value": ""
        ...
        '''
        urlPath='/certificate/{cert_id}/sign'
        dictPath={'cert_id': cert_id}
        for item in dictPath:
            urlPath=urlPath.replace('{'+item+'}',dictPath[item])
        body = _removeEmptyKeys(keys=body)
    ...
    def getOnboardDevice(self,filter="",sort="",offset="",limit="",calculate_count=""):
        '''
    ...
    def updateOnboardDeviceById(self,id="",body=({})):
        '''
  ...
  "device_identifier": ""
    ...
    def deleteOnboardDeviceById(self,id="",disconnect_active_sessions="",ignore_disconnect_errors=""):
        '''
